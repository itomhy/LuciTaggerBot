...
async def start(event):
  await event.reply("**🌀TaggerBot**\n ile Grubunuzdakı Bütün istifadeçileri tag ede bilersen \nKomutlar için =======> /help yazın**",
                    buttons=(
                   
		      [Button.url('Qrupa Elave Et ➕', 'https://t.me/lucitaggerbot?startgroup=a')],
                      [Button.url('Support🛠', 'https://t.me/itomhyy')],
                      [Button.url('Resmi Kanal📣', 'https://t.me/itomhyblogs')],
		      [Button.url('Developer👨🏻‍💻', 'https://t.me/itomhyy')],
                    ),
                    link_preview=False
                   )
...
async def help(event):
  ...
  await event.reply(helptext,
                    buttons=(
                     [Button.url('Qrupa Elave Et ➕', 'https://t.me/tageleme_bot?startgroup=a')],
                      [Button.url('Support🛠', 'https://t.me/itomhyy')],
                      [Button.url('Resmi Kanal📣', 'https://t.me/itomhyblogs')],
		      [Button.url('Developer👨🏻‍💻', 'https://t.me/itomhyy')],
                    ),
...
async def help(event):
  helptext = "**Çok özellikleri Etiket Botu Bulmaya Çalışan Grub Sahibleri @ Size Göre:\n\n📌 5-li etiket\n📌 Emoji etiket\n📌 Tekli Etiket\n📌 Yalnız Yöneticileri etiketleme\n📌\n\n Böyle Çok özellikli @LuciTaggerBot 'u grubunuza yönetici olarak ekleyip rahatlıkla üyelir , etiket ata bilirsiz **"
  await event.reply(helptext,
                    buttons=(
                      [Button.url('Botu Gruba Ekle➕', 'https://t.me/tageleme_bot?startgroup=a')],
                    ),
                    link_preview=False
                   )
...
async def mentionall(event):
  global anlik_calisan
  if event.is_private:
    return await event.respond("Bu komutu gruplar ve kanallar üçün geçerli❗️**")
  ...
  if event.pattern_match.group(1):
    ...
    return await event.respond("Başlamag ucun sebeb yox ")
  else:
    return await event.respond("Tag elemeye sebeb yoxdu")
  ...
  if mode == "text_on_reply":
    ...
    async for usr in client.iter_participants(event.chat_id):
      ...
      usrtxt += f"👥 - [{usr.first_name}](tg://user?id={usr.id}) \n"
      if event.chat_id not in anlik_calisan:
        await event.respond("durduruldu❌")
        return
      if usrnum == 5:
        await client.send_message(event.chat_id, usrtxt, reply_to=msg)
        await asyncio.sleep(2)
...
print(">> Bot çalır narahat olma 🚀 @itomhyy melumat alabilirsen <<")
